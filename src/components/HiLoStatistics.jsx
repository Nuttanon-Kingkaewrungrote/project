          ...
          <div className="bg-white rounded-xl shadow-lg border border-gray-200 overflow-hidden">
            ...
            <thead className="relative">
              <tr className="bg-blue-600 text-white">
                <th className="py-3 px-4 text-center font-semibold border-r border-white w-1/2 rounded-tl-xl">
                    ...
                    {activeFilter !== 'all' && (
                      <div className="relative inline-block">
                        <button
                          ...
                          className="w-4 h-4 rounded-full border border-white text-white flex items-center justify-center text-xs font-bold hover:bg-white hover:text-blue-600 transition-colors"
                        >
                          i
                        </button>
                        {showTooltip && (
                          <div className="absolute bottom-full mb-2 left-1/2 transform -translate-x-1/2 bg-white text-gray-800 text-xs px-3 py-2 rounded-lg whitespace-nowrap z-50 shadow-lg border border-gray-200">
                            {getTooltipText()}
